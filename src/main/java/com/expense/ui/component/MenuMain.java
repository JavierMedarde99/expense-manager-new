...
public class MenuMain extends VerticalLayout{
    ...
    public MenuMain(String userName, BillService billService,SubTypesService subTypesService) {
        ...
        showTables(userName, billService,subTypesService);
    ...
    private void showTables(String userName, BillService billService,SubTypesService subTypesService) {
        ...
        TableBill tableBillThisMonth = new TableBill(userName, billService,
                LocalDate.now().getMonthValue(), LocalDate.now().getYear(),subTypesService);
        ...
        TableBill tableBillLastMonth = new TableBill(userName, billService,
                LocalDate.now().minusMonths(1).getMonthValue(), LocalDate.now().minusMonths(1).getYear(),subTypesService);
